...
class info {
    static void cmdinfo() {
        System.out.println("\nPress [ENTER] to roll the dice\n" +
                "QUICK SHORTCUT : THERE WILL BE SHORTCUTS TO GET QUICKER ROUTE TO ESCAPE THIS MAZE\n" +
                "WRONG TURNS : IT MIGHT POSSIBLE THAT YOU CAN LOST YOUR TRACK AND GET BACK TO THE EARLY STEPS THAT YOU HAVE ALREADY PASSED\n\n" +
                "other commands :\n" +
                "rst : TO RESTART THE GAME. YOU WILL LOST ALL YOUR PROGRESS.\n" +
                "ext : EXIT THE GAME\n" +
                "magicportal : INFO ABOUT MAGIC PORTAL\n" +
                "dreamymist : INFO ABOUT DREAMY MIST\n" +
                "chupakabra : INFO ABOUT CHUPAKABRA\n");
    }

    static void magicportal() {
        System.out.println("MAGIC PORTAL:\n" +
                " IT'S A WORMHOLE THROUGH THE MAZE, APPEARS ANYWHERE BETWEEN YOUR JOURNEY. IT WILL TELEPORT TO ANYWHERE BETWEEN YOUR JOURNEY,\n" +
                " WHEN YOU GOT A PORTAL YOU HAVE TWO CHOICE EITHER TO USE OR AVOID IT. THERE IS A RISK USING A MAGIC PORTAL THAT\n" +
                " THERE IS A POSSIBILITY THAT YOU MIGHT BE TELEPORTED TO THE DEVIL'S KITCHEN ");
    }

    static void dreamyfist() {
        System.out.println("DREAMY MIST:\n" +
                " SOMETIMES THERE WILL BE SOME TYPE OF MIST WILL APPEAR IN THAT CAVE WHICH WILL MAKE YOU HALLUCINATE ABOUT YOUR MOST DESIRED DREAM.\n" +
                " IT WILL BE SO REAL THAT YOU CAN'T ABLE DIFFERENTIATE WHAT IS REAL OR WHAT'S NOT\n" +
                " IF YOU DIDN'T WAKE UP IN TIME YOU WILL BE UNCONCIOUS AND EVENTUALLY DEAD\n" +
                " in order to wake up from the dream you have to roll up the dice to the 6\n" +
                " you will get only 7 times to roll the dice to 6 after this you will be out from this game ");
    }

    static void chupakabra() {
        System.out.println("CHUPAKABRA:\n" +
                "IT'S A SUPERNATURAL CREATURE ALWAYS ON A HUNT OF FRESH HUMAN MEAT. THEY USUALLY HIDE IN THE CAVES. YOU WOULDN'T LIKE\n" +
                "TO SEE ONE OF THEM IN FRONT OF YOU. IN CASE YOU HAVE ACCIDENTALLY ENCOUNTERED WITH A KABRA, YOU SHOULD HAVE MAINTAIN\n" +
                "DISTANCE WITH IT FOR YOUR OWN SAFETY. BUT IF YOU WANT YOU CAN PASS BY ITS BLIND SPOT BY CRAWLING, BUT IT'S NOT SUGGESTED\n" +
                "AS THEY ARE THE HUNTER KIND OF CREATURES, THEY HAVE VERY STRONG SENSES SO IT'S NOT EASY TO CROSS THEM WITHOUT BEING UNNOTICED.\n" +
                "THERE IS MERELY 20% CHANCE IT CAN'T NOTICE YOU ARE IN DOWN POSITION BUT AGAIN IT WOULD BE PREFERRED THAT YOU STEP BACK AND LET\n" +
                "IT GO IN ITS WAY");
    }

    static void credit() {
        System.out.println("MADE BY SUVAM CHOUDHURY.\nSO HOW WAS THE GAME ? IT WAS THE FIRST TIME" +
                " I'M DOING SOMETHING LIKE THIS FOR FIRST TIME SO YOUR FEEDBACK WILL BE VERY APPRECIATED");
        System.out.println("        ---                                                      \n" +
                "       / _ \\                                                     \n" +
                "      | / \\ |                                                    \n" +
                "     / /   \\ \\                                                   \n" +
    ...
    static void motivate() {
        System.out.println("THE WORLD IS CRUEL. THE ONLY WAY TO GET YOUR FREEDOM IS TO KEEP MOVING FORWARD." +
                "SO JUST FIGHT...!\n" +
                "TATAKE\n");
    }

    static void srccmd() {
        System.out.println("THERE ARE SOME OTHER COMMANDS NOT PRETTY MUCH IMPORTANT FOR THIS GAME\ncredit\n619\nmotivate\ndice\n108");
    }
}
